...
/**
 * check_elf - Checking if the file is an ELF file.
 * @e_ident: An array containing the ELF magic numbers.
 *
 * Description: Checks if the file is not an ELF file and exits with code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int counter;
 ...
 * @e_ident: An array containing the ELF magic numbers.
 *
 * Description: Prints the magic numbers, separating them by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int counter;
 ...
 * @e_ident: An array of ELF version.
 *
...
/**
 * print_osabi - Prints the ABI of an ELF header.
 * @e_ident: An array of the ELF version.
 *
 * Description: Prints the ABI of the ELF header.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_ident: An array of ELF ABI version.
 *
 ...
 * @elf: Description of the ELF file.
 *
 * Description: If the file can't be closed, exits with code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * Return: 0 (success)
 *
 * Description: Exits with code 98 if the file is
