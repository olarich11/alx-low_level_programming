...
/**
 * create_xarry- Creates an array of chars and initializes it with
 ...
 * containing leading zeroes until it hits a non zero numbers
 ...
 * contains non digits,the function exits with a status
 * Return: Always 0
 */
int main(int argc, char *argv[])
{
	...
	size + find_len(argv[argv[1]) + find_len(argv[2]);
